...
-- Table: users (new for login/signup)
...
('Rocket Propulsion Competition', 'Competition on rocket engines.', '2024-10-15', 'competition'),
('Space Medicine Webinar', 'Webinar on health in space.', '2024-11-05', 'webinar'),
('Inter-college Space Quiz', 'Quiz competition for colleges.', '2024-11-20', 'college_event'),
('Astrophysics Conference', 'Conference on astrophysics.', '2024-12-01', 'college_event'),
('Mars Mission Planning', 'Planning for Mars exploration.', '2025-01-10', 'webinar'),
('Satellite Communications Workshop', 'Workshop on satellite comms.', '2025-02-15', 'college_event'),
('Space Exploration Competition', 'Competition on space exploration.', '2025-03-05', 'competition'),
('Astronomy Webinar', 'Webinar on astronomy topics.', '2025-03-20', 'webinar'),
('College Space Hackathon', 'Hackathon for space tech projects.', '2025-04-10', 'college_event');
